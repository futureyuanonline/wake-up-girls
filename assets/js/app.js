...
var UI = {
  'zh-CN': {
    ...
    'shop.label': 'Shop · 好物',
    'shop.title': '支持女性自主创业的商品',
    'shop.intro': '为保障网站在国内长期稳定运行（服务器、域名与接口费用），我们开设这一栏。这里只放一件事：由女性创办或主理的品牌，且我们自己了解、愿意推荐的商品。',
    'shop.how_t': '我们的筛选标准',
    'shop.how_d': '① 女性创办或主理（会写明是哪一种）　② 中价可获得，不推高价奢侈品与冲动消费　③ 我们自己用过或深入了解过　④ 不接受付费上榜与软文，收益来自明确的联盟链接或自营',
    'shop.slots_t': '首批推荐位',
    'shop.slots_d': '推荐位正在选品中。我们优先考虑女性创办的家居、健康、文具、母婴与工装类品牌；如果你在经营这样的品牌，欢迎来信自荐（附品牌介绍与创始人信息）。',
    'shop.contact_t': '品牌合作与读者推荐',
    'shop.contact_d': '品牌方：请来信说明创始人、品牌与商品，我们不收取上榜费用。读者：如果你用过值得推荐、由女性创办的商品，也欢迎写信告诉我们。',
    'shop.disclosure_t': '收益与标注',
    'shop.disclosure_d': '每条推荐都会标明：价格区间、是否联盟链接、我们与品牌的关系。本站所有内容仍然免费开放，推荐收益只用于维持网站运行。',
    'nav.cta': '订阅周刊',
    'brand.tag': '全球女性议题周报',
    ...
    'footer.collab_submit': '征稿启事与投稿规范',
    'footer.collab_submit': '徵稿啟事與投稿規範',
    'footer.collab_submit': 'Call for pitches & guidelines',
    'footer.collab_link': '友情链接交换（虚位以待）',
    'footer.collab_link': '友情連結交換（虛位以待）',
    'footer.collab_link': 'Link exchange (open slots)',
    'footer.collab_shop': '品牌合作：女性自主创业商品',
    'footer.collab_shop': '品牌合作：女性自主創業商品',
    'footer.collab_shop': 'Brands: women-founded products',
    'footer.collab': '合作与征稿',
    'footer.collab': '合作與徵稿',
    ...
    'about.v1_t': '独立', 'about.v1_d': '我们不收软文与政治赞助。为保障网站在国内长期运行，我们只推荐「女性自主创业」的商品，价格与是否联盟链接都会明确标注，收益全部用于维持网站运行（服务器、域名与接口费用）。我们的立场只服务于事实与女性权益。',
    ...
    'submit.g4_d': '本站目前为个人公益项目，稿酬按篇协商（部分专题有预算）；选题通过后 7 天内回复，未通过也会回复。',
    'submit.g4_d': '本站目前為個人公益項目，稿酬按篇協商（部分專題有預算）；選題通過後 7 天內回覆，未通過也會回覆。',
    'submit.g4_d': 'This is currently a personal non-profit project; payment is negotiated per piece (some themed issues have a budget). We reply within 7 days either way.',
    'submit.g4_t': '稿酬与周期',
    'submit.g4_t': '稿酬與週期',
    'submit.g4_t': 'Payment and timing',
    'submit.g3_d': '默认要求原创首发；作者保留著作权，本站获得非独家的长期展示与转载授权（会标注作者与来源）。如已在别处发表，请在来信中说明。',
    'submit.g3_d': '預設要求原創首發；作者保留著作權，本站獲得非獨家的長期展示與轉載授權（會標注作者與來源）。如已在別處發表，請在來信中說明。',
    'submit.g3_d': 'Original, first-publication by default. You keep copyright; we get a non-exclusive licence to publish and repost long-term with credit. If it appeared elsewhere, tell us.',
    'submit.g3_t': '授权与署名',
    'submit.g3_t': '授權與署名',
    'submit.g3_t': 'Rights and credit',
    'submit.g2_d': '800–3000 字；也可以是 300 字左右的一条观察。中文优先，英文或繁体亦可。需要事实来源，数字与机构名请附原文链接。',
    'submit.g2_d': '800–3000 字；也可以是 300 字左右的一條觀察。中文優先，英文或繁體亦可。需要事實來源，數字與機構名請附原文連結。',
    'submit.g2_d': '800–3000 words, or a single 300-word observation. Chinese preferred; English or Traditional Chinese welcome. Facts need sources — link original material for any figure or institution.',
    'submit.g2_t': '篇幅与形式',
    'submit.g2_t': '篇幅與形式',
    'submit.g2_t': 'Length and form',
  ...
  'zh-Hant': {
    ...
    'shop.label': 'Shop · 好物',
    'shop.title': '支持女性自主創業的商品',
    'shop.intro': '為保障網站在國內長期穩定運行（伺服器、網域與介面費用），我們開設這一欄。這裡只放一件事：由女性創辦或主理的品牌，且我們自己了解、願意推薦的商品。',
    'shop.how_t': '我們的篩選標準',
    'shop.how_d': '① 女性創辦或主理（會寫明是哪一種）　② 中價可獲得，不推高價奢侈品與衝動消費　③ 我們自己用過或深入了解過　④ 不接受付費上榜與軟文，收益來自明確的聯盟連結或自營',
    'shop.slots_t': '首批推薦位',
    'shop.slots_d': '推薦位正在選品中。我們優先考慮女性創辦的家居、健康、文具、母嬰與工裝類品牌；如果你在經營這樣的品牌，歡迎來信自薦（附品牌介紹與創始人資訊）。',
    'shop.contact_t': '品牌合作與讀者推薦',
    'shop.contact_d': '品牌方：請來信說明創始人、品牌與商品，我們不收取上榜費用。讀者：如果你用過值得推薦、由女性創辦的商品，也歡迎寫信告訴我們。',
    'shop.disclosure_t': '收益與標注',
    'shop.disclosure_d': '每條推薦都會標明：價格區間、是否聯盟連結、我們與品牌的關係。本站所有內容仍然免費開放，推薦收益只用於維持網站運行。',
    'nav.cta': '訂閱週刊',
    'brand.tag': '全球女性議題週報',
    ...
    'about.v1_t': '獨立', 'about.v1_d': '我們不收軟文與政治贊助。為保障網站在國內長期運行，我們只推薦「女性自主創業」的商品，價格與是否聯盟連結都會明確標注，收益全部用於維持網站運行（伺服器、網域與介面費用）。我們的立場只服務於事實與女性權益。',
  ...
  en: {
    ...
    'shop.label': 'Shop',
    'shop.title': 'Products from women-founded businesses',
    'shop.intro': 'This section exists to keep the site running in mainland China (servers, domain, APIs). It only carries one thing: products from brands founded or led by women that we know and would recommend ourselves.',
    'shop.how_t': 'How we choose',
    'shop.how_d': '① Founded or led by women (we say which)　② Mid-priced and accessible — no luxury or impulse buys　③ We have used it or know it in depth　④ No paid placement, no sponsored posts; proceeds come from disclosed affiliate links or our own stock',
    'shop.slots_t': 'First slots',
    'shop.slots_d': 'Slots are being filled. We are prioritising women-founded brands in home, health, stationery, mother-and-baby and workwear. If you run one, write to us with the brand and founder details.',
    'shop.contact_t': 'Brands and reader picks',
    'shop.contact_d': 'Brands: tell us about the founder, the brand and the product — there is no listing fee. Readers: if you have used something good from a women-founded brand, tell us too.',
    'shop.disclosure_t': 'Disclosure',
    'shop.disclosure_d': 'Every recommendation states the price range, whether it is an affiliate link, and our relationship with the brand. All editorial content stays free; recommendation income only covers running costs.',
    'nav.cta': 'Subscribe',
    ...
    'about.v1_t': 'Independent', 'about.v1_d': 'We take no sponsored posts and no political funding. To keep this site running in mainland China over the long term, we only recommend products from women-founded businesses; prices and any affiliate links are always disclosed, and all proceeds go to running costs (servers, domain, APIs). Our position serves facts and women’s rights only.',
